...
export type Assets<T extends string, U> = { [P in T]: U }

export const defaultColors: Assets<StatusType, string> = {
  success: '#18be52',
  failure: '#E96D76',
  cancelled: '#3b3b82',
  custom: '#e9e9e9'
...
export const defaultText: Assets<StatusType, string> = {
...
export const defaultFooter = '<https://github.com/yukin01/slack-bot-action|Slack Bot Action>'
